...
export const SUCCESUFULY_LOADED_PICTURE_REVIEWS =
...
export const SUCCESSFUL_LOADED_PICTURES_USER =
  "SUCCESSFUL_LOADED_PICTURES_USER";

export const START_LOADING_USER = "START_LOADING_USER";

export const SUCCESUFULY_LOADED_PICTURES_HOME =
  "SUCCESSFUL_LOADED_PICTURES_HOME";

export const LOADING_LOGIN_FORM = "LOADING_LOGIN_FORM";
export const SUCCESSFUL_LOGGEDIN = "SUCCESSFUL_LOGGEDIN";

export const SUCCESSFUL_CREATED_PICTURE = "SUCCESSFUL_CREATED_PICTURE";
